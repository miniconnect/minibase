...
binaryStringTokenList: TOKEN_BSTRING TOKEN_BSTRING_CONTINUATION*;
hexadecimalStringTokenList: TOKEN_XSTRING hexadecimalStringContinuation*;
hexadecimalStringContinuation: TOKEN_BSTRING_CONTINUATION | TOKEN_XSTRING_CONTINUATION;
...
escapeStringContinuation: safeStringToken | TOKEN_ESTRING_CONTINUATION;
