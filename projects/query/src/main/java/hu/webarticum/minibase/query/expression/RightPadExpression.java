...
public class RightPadExpression implements Expression {
    ...
    private String operate(String input, int length, String pad) {
        ...
        if (padFraction > 0) {
            resultBuilder.append(effectivePad.substring(0, padFraction));
        }
    ...
    public String automaticName() {
        return "RPAD(" + inputExpression.automaticName() + ", " + lengthExpression.automaticName() + ")";
    }
