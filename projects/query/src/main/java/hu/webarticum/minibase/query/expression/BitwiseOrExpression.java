...
public class BitwiseOrExpression implements Expression {
    ...
    public BitwiseOrExpression(Expression leftOperand, Expression rightOperand) {
    ...
    public Object evaluate(ImmutableMap<Parameter, Object> values) {
        ...
        if (leftIsNumber && rightIsNumber) {
            ...
            return leftLargeIntegerValue.or(rightLargeIntegerValue);
        }
        ...
        return leftBitString.or(rightBitString);
    }
