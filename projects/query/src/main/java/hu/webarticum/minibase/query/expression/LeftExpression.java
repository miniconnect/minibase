...
public class LeftExpression implements Expression {
    ...
    public LeftExpression(Expression contextOperand, Expression lengthOperand) {
    ...
    private String operate(String context, int length) {
        ...
        return length > 0 ? context.substring(0, length) : "";
    }
    ...
    private ByteString operate(ByteString context, int length) {
        ...
        return length > 0 ? context.substring(0, length) : ByteString.empty();
    }
    ...
    private BitString operate(BitString context, int length) {
        ...
        return length > 0 ? context.substring(0, length) : BitString.empty();
    }
